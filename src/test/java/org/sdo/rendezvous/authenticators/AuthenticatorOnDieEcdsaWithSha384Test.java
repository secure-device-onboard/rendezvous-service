...
public class AuthenticatorOnDieEcdsaWithSha384Test {

  private static final byte[] PAYLOAD =
      DatatypeConverter.parseHexBinary("64616c74657374");
   ...
   *
   * @throws Exception for NoSuchAlgorithmException, InvalidKeyException, SignatureException or any
