...
public class AuthenticatorEcdsaWithSha256Test {

  private static final byte[] PAYLOAD =
      DatatypeConverter.parseHexBinary("b1ce908ddea06d666fe9993c6651cb75");
  private static byte[] VALID_SIGNATURE;
  private AuthenticatorEcdsaWithSha256 authenticator;
  ...
  public void before() throws Exception {
    authenticator = new AuthenticatorEcdsaWithSha256();
