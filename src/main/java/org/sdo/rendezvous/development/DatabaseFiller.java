...
public class DatabaseFiller {
  ...
  private static final String GUID_BLACKLIST_NAME = "GUIDS_BLACKLIST";
  ...
  private static final String[] WHITELISTED_KEYS_HASHES_ARRAY = {
  ...
  // this key hash has been calculated from public key of
  // /Validation/TestData/OwnershipVoucher/p6_blacklisted.cert.pem
  // instruction how it was calculated can be found
  // /Validation/TestData/OwnershipVoucher/openssl_instructions.md
  private static final String[] BLACKLISTED_KEYS_HASHES_ARRAY = {
  ...
  private static final String[] BLACKLISTED_GUIDS_ARRAY = {"0000000000000000000000000000FFFF"};

  private static final List<String> WHITELISTED_KEYS_HASHES =
      new ArrayList<>(Arrays.asList(WHITELISTED_KEYS_HASHES_ARRAY));
  private static final List<String> BLACKLISTED_KEYS_HASHES =
      new ArrayList<>(Arrays.asList(BLACKLISTED_KEYS_HASHES_ARRAY));
  private static final List<String> BLACKLISTED_GUIDS =
      new ArrayList<>(Arrays.asList(BLACKLISTED_GUIDS_ARRAY));
  ...
  private void fill() throws IOException {
    assignHashesToKey(WHITELIST_HASHSET_NAME, WHITELISTED_KEYS_HASHES);
    assignHashesToKey(BLACKLIST_HASHSET_NAME, BLACKLISTED_KEYS_HASHES);
    assignHashesToKey(GUID_BLACKLIST_NAME, BLACKLISTED_GUIDS);
  }
