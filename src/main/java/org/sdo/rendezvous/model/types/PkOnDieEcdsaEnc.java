...
@Slf4j
public class PkOnDieEcdsaEnc extends PubKey {
   ...
   */
  public PkOnDieEcdsaEnc(PublicKeyType publicKeyType, byte[] pubKeyBytes) {
  ...
  public PublicKey asJavaPublicKey() throws InternalCryptoException, ResourceNotFoundException {
    ...
    try {
      ...
      log.debug(
          "Could not convert OnDie ECDSA key from database to PublicKey object. Error: {}",
          e.getMessage());
